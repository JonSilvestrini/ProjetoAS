 ...
 * @author Jonatas
 */
public class TelaRelaEstoque extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaRelaLucro
     */
    public TelaRelaEstoque(String user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Produto que mais tem");

        lblGst.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        lblGst.setText("jLabel6");

        jLabel7.setText("Produto que menos tem");
        ...
        tbp_info.addTab("Produtos", jPanel1);
        ...
        tbp_info.addTab("Vencimento", jPanel2);
    ...
    private void btnConsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsActionPerformed
        ...
        lblRec.setText("Qtd Total");
        lblGst.setText("Produto (Qtd)");
        lblLcr.setText("Produto (Qtd)");
